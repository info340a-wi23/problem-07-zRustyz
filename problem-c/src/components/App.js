...
function App(props) {
  ...
  const displayedGames = props.gameData.filter((game) => {
    if ((team === '') || (game.winner === team) || (include && game.runner_up === team)) {
      return game;
    }
  })

  const applyFilter = (teamName, runnerUp) => {
    updateTeam(teamName);
    updateInclude(runnerUp);
  }
  ...
  return (
    <div className="container">
      ...
      <main>
        ...
        <GameDataTable data={displayedGames} />
      </main>
